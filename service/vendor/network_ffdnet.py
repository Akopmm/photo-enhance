# -*- coding: utf-8 -*-
#
# Vendored from https://github.com/cszn/KAIR (MIT), fetched 2026-08-29.
# Verbatim apart from the import line, which upstream writes as
# `import models.basicblock as B` and would need a `models` package on the
# path purely to satisfy it.
#
