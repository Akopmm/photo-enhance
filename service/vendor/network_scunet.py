# -*- coding: utf-8 -*-
#
# Vendored from https://github.com/cszn/SCUNet (Apache-2.0), commit as fetched
# 2026-08-26. Architecture only -- the weights are pulled separately in the
# Dockerfile. Kept verbatim apart from dropping the `thop` import, which only
# served the file's own __main__ demo and is not a runtime dependency.
#
#   Zhang et al., "Practical Blind Denoising via Swin-Conv-UNet and Data
#   Synthesis", Machine Intelligence Research, 2023.
import math
import torch
import torch.nn as nn
import numpy as np
# thop is only used by the file's __main__ demo block
